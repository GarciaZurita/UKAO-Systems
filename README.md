...
Prueba 1: Alimentación y continuidad 
 ...
 • Se midió con multímetro la continuidad entre GND del Arduino y la línea 
negativa de la protoboard. 
 • Resultado: 5.01 V estables; sin pérdida de tensión. 
 
Prueba 2: Lectura analógica del sensor de pulso 
 • Se conectó el potenciómetro en A0 y se imprimieron los valores por 
monitor serial. 
 • Resultado: el rango de lectura fue de 0 a 1023, confirmando una 
conversión analógica correcta. 

Prueba 3: Comunicación I2C de la pantalla LCD 
 • Se usó un escáner I2C para encontrar la dirección del módulo (0x26). 
 • Resultado: LCD reconocida correctamente y operativa tras ajustar la 
 dirección en el código. 

Prueba 4: Salidas digitales 
 • Cada LED fue probado individualmente con un sketch simple para 
 verificar polaridad y resistencias. 
 • El buzzer respondió correctamente a tonos de 700 Hz, 1000 Hz y 2000 Hz. 
 
Prueba 5: Ejecución del sketch completo 
 • Se observó en el monitor serial y en el LCD el comportamiento del 
sistema al girar el potenciómetro. 
 • Resultado: el estado cambiaba automáticamente según el valor del 
pulso simulado. 
